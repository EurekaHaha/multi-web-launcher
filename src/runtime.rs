...
use crate::{config::ProjectConfig, log, project};

use sysinfo::System;


pub fn start_projects(project_config: Vec<ProjectConfig>, sys: &mut System) -> HashMap<String, log::NodeLog> {
    project_config
        .into_iter()
        .map(|project| {
...
pub fn process_commands(logs: &mut HashMap<String, log::NodeLog>, sys: &mut System) {
...
pub fn print_sys_info(sys: &mut System) {
    sys.refresh_memory();
